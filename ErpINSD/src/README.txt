...
2. Hybrid App Configuration
  ...
  b. Install Cordova plugins:
    ojet add plugins cordova-plugin-camera cordova-plugin-contacts cordova-plugin-geolocation cordova-plugin-splashscreen cordova-plugin-network-information cordova-plugin-wkwebview-file-xhr

    * The following plugin versions have been tested with Cordova CLI v7.0.1:
...
4. Enable push notifications (optional)
  ...
  c. Add Android & iOS mobile clients to your MCS MBE and in their profiles specify the requisite FCM & APNs details obtained in step b
